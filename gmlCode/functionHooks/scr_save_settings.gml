...
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Optimized Saving")
file_text_writeln(file)
file_text_write_real(file, global.setting_optimized_saving)
repeat (2)
    file_text_writeln(file)
/*
file_text_write_string(file, "Persistent Clipboard")
file_text_writeln(file)
file_text_write_real(file, global.setting_persistent_clipboard)
repeat (2)
    file_text_writeln(file)
*/
file_text_write_string(file, "Copyable Wires")
file_text_writeln(file)
file_text_write_real(file, global.setting_copyable_wires)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Preserve Copy Order")
file_text_writeln(file)
file_text_write_real(file, global.setting_preserve_copy_order)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Spawnpoint Switcher")
file_text_writeln(file)
file_text_write_real(file, global.setting_spawnpoint_switcher)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Grid Contrast")
file_text_writeln(file)
file_text_write_real(file, global.setting_editorGrid_contrast)
repeat (2)
    file_text_writeln(file)
