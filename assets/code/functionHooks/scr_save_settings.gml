...
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Tile Bar Color")
file_text_writeln(file)
file_text_write_real(file, global.setting_shw_theme_titleBar)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Title Bar Active Color")
file_text_writeln(file)
file_text_write_real(file, global.setting_shw_theme_titleBarActive)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Title Bar Collapsed Color")
file_text_writeln(file)
file_text_write_real(file, global.setting_shw_theme_titleBarCollapsed)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Window BG Color")
file_text_writeln(file)
file_text_write_real(file, global.setting_shw_theme_windowBG)
repeat (2)
    file_text_writeln(file)
