    switch argument1
{
    ...
    case 2:
        ...
        for (indx = 0; indx < ds_list_size(li_objects_in_box); indx++)
        {
            ...
            {
                if ((inst_toolStruct.can_be_copied == 0 || (inst_toolStruct.can_be_copied == 3 && (inst_check.image_xscale != 1 || inst_check.image_yscale != 1))) && !global.setting_copy_tool_bypass)
                {
                }
                else {
